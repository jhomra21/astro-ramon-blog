---
title: 'FastAI Photos - Create Custom AI Photos Instantly'
...
pubDate: '2024-11-23'
heroImage: "/src/assets/images/fastaiphotos-landing-page.png"
tags: ['AI', 'Image Generation', 'Machine Learning', 'LoRA']
isProject: true
projectUrl: 'https://fastaiphotos.com'
projectStatus: 'live'
projectType: 'featured'
techStack: [
    { name: 'Solid.js', description: 'Frontend framework' },
    { name: 'Hono.js', description: 'Backend/server' },
    { name: 'Fal.ai', description: 'GPU inference provider' },
    { name: 'Together AI', description: 'GPU inference provider' },
    { name: 'Cloudflare', description: 'Hosting, web services' },
    { name: 'Supabase', description: 'Database backend postgres' },
